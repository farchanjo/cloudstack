...
import com.cloud.upgrade.dao.Upgrade42426to42427;
import com.cloud.upgrade.dao.Upgrade42427to42428;
import com.cloud.upgrade.dao.Upgrade42428to42429;
import com.cloud.upgrade.dao.Upgrade42429to42430;
import com.cloud.upgrade.dao.Upgrade42430to42431;
import com.cloud.upgrade.dao.Upgrade42431to42432;
import com.cloud.upgrade.dao.Upgrade42432to42433;
import com.cloud.upgrade.dao.Upgrade42433to42434;
...
public class DatabaseUpgradeChecker implements SystemIntegrityChecker {
    ...
    public DatabaseUpgradeChecker() {
        ...
        hierarchy = DatabaseVersionHierarchy.builder()
                ...
                .next("4.24.1.26", new Upgrade42426to42427())
                .next("4.24.1.27", new Upgrade42427to42428())
                .next("4.24.1.28", new Upgrade42428to42429())
                .next("4.24.1.29", new Upgrade42429to42430())
                .next("4.24.1.30", new Upgrade42430to42431())
                .next("4.24.1.31", new Upgrade42431to42432())
                .next("4.24.1.32", new Upgrade42432to42433())
                .next("4.24.1.33", new Upgrade42433to42434())
                .build();
    }
