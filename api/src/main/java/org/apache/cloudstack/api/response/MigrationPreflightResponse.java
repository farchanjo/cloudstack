...
public class MigrationPreflightResponse extends BaseResponse {
    ...
    @SerializedName("vmid") @Param(description = "VM ID") private long vmId;
    @SerializedName("destinationhostid") @Param(description = "Destination host ID") private long destinationHostId;
    ...
    public static MigrationPreflightResponse from(final MigrationPreflightResult result) {
        ...
        response.vmId = result.vmId();
        response.destinationHostId = result.destinationHostId();
