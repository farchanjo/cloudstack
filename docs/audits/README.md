...
|---|---|---|---|---|---|
| 2026-05-09 | `2026-05-09-ovn-fork-audit.md` | OVN fork DB + API + UI inconsistencies + LB selection_fields + LB update state-machine | 10 | 9 | 1 (Bug 10 — `updateLoadBalancerRule` algo no re-sync, LOW) |
